                            ...
                            <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                <div class="card-header align-items-center  border-bottom-dark px-0">
                                    ...
                                    <div class="icons d-flex">
                                        <router-link to="/admin/add-sale-quotation" class="btn ml-2 p-0 kt_notes_panel_toggle btn-outline-black" data-toggle="tooltip" title="" data-placement="right" data-original-title="Check out more demos" v-if="$parent.permissions.includes('quotation-manage')">
                                            ...
                                            <div id="sale_filter" class="dataTables_filter">
                                                ...
                                                <table id="sale" class="display dataTable no-footer order--table" sale="grid">
                                                    ...
                                                    <tbody class="kt-table-tbody text-dark">
                                                        ...
                                                        <tr v-if="sale_quotations.length == 0" class="text-center font-size-16"><td colspan="9">No Order Found</td></tr>
                                                    </tbody>
                                                </table>
                                                <ul class="pagination pagination-sm mb-0 mt-3 justify-content-end align-items-center px-2" v-if="sale_quotations.length != 0">
                                                    <li v-bind:class="[{disabled: !pagination.prev_page_url}]"><button class="page-link" href="#" @click="fetchsale_quotations(pagination.prev_page_url)">
                                                    ...
                                                    <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item"><button class="page-link" href="#" @click="fetchsale_quotations(pagination.next_page_url)">
    ...
    methods: {
        fetchsale_quotations(page_url) {
            ...
            if(Number.isInteger(page_url)){
                page_url ="/api/admin/sale_quotation?page="+page_url;
            }
