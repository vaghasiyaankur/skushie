                    ...
                    <div class="row mb-3 align-items-center">
                      ...
                      <div class="col-md-3">
                        ...
                        <button style="padding:7px 20px;"
                          class="btn btn-outline-purple border_radius_5 mt-2" @click="fetchStockOnHand('')">
                        ...
                        >
                          ...
                          >
                            ...
                            <tbody class="kt-table-tbody text-dark">
                              ...
                              <tr v-if="stocks.length == 0" class="text-center font-size-16"><td colspan="6">No Order Found</td></tr>
                            </tbody>
                          </table>
                          <ul class="pagination pagination-sm mb-0 mt-3 justify-content-end align-items-center px-2" v-if="stocks.length != 0">
                            <li v-bind:class="[{disabled: !pagination.prev_page_url}]"><button class="page-link" href="#" @click="fetchStockOnHand(pagination.prev_page_url)">
                            ...
                            <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item"><button class="page-link" href="#" @click="fetchStockOnHand(pagination.next_page_url)">
  ...
  methods: {
    fetchStockOnHand(page_url) {
      ...
      if(Number.isInteger(page_url)){
        page_url ="/api/admin/reports/stock-on-hand?page="+page_url;
      }
