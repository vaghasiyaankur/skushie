                            ...
                            <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                <div class="card-header align-items-center  border-bottom-dark px-0">
                                    ...
                                    <div class="icons d-flex">
                                        <router-link to="/admin/roles/permissions/add" class="btn ml-2 p-0 kt_notes_panel_toggle btn-outline-black" data-toggle="tooltip" title="" data-placement="right" data-original-title="Check out more demos" v-if="$parent.permissions.includes('role-manage')">
                                ...
                                <div class="card-body">
                                    <div>
                                        <div class=" table-responsive" id="printableTable">
                                            ...
                                            <div class="dataTables_length mb-3" id="Role_length"><label>Show 
                                            ...
                                            <div id="Role_filter" class="dataTables_filter mb-3">
                                                ...
                                                <table id="Role" class="display dataTable no-footer order--table" role="grid">
                                                    ...
                                                    <tbody class="kt-table-tbody text-dark">
                                                        <tr class="kt-table-row kt-table-row-level-0 odd" role="row" v-for="role in roles" v-bind:key="role.id">
                                                            ...
                                                            <td v-if="$parent.permissions.includes('role-manage') && role.id != 1" class="white__nowrap">
                                                                <router-link :to="'/admin/roles/permissions/'+role.id+'/'+role.name" class="click-edit btn btn-outline-primary text-nowrap  waves-effect p-2" >
                                                                ...
                                                                <a v-if="role.id > 7" class="btn btn-outline-danger text-nowrap  waves-effect p-2" href="#" @click="deleteRole(role.id)">
                                                        ...
                                                        <tr v-if="roles.length == 0" class="text-center font-size-16"><td colspan="3">No Order Found</td></tr>
                                                    </tbody>
                                                </table>
                                                <ul class="pagination pagination-sm mb-0 mt-3 justify-content-end align-items-center px-2" v-if="roles.length != 0">
                                                    <li v-bind:class="[{disabled: !pagination.prev_page_url}]"><button class="page-link" href="#" @click="fetchRoles(pagination.prev_page_url)">
                                                    ...
                                                    <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item"><button class="page-link" href="#" @click="fetchRoles(pagination.next_page_url)">
    ...
    methods: {
        fetchRoles(page_url) {
            ...
            if(Number.isInteger(page_url)){
                page_url ="/api/admin/role?page="+page_url;
            }
