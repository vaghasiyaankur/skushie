                            ...
                            <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                <div class="card-header align-items-center  border-bottom-dark px-0">
                                    ...
                                    <div class="icons d-flex">
                                        <button class="btn ml-2 p-0 kt_notes_panel_toggle btn-outline-black" data-toggle="tooltip" title="" data-placement="right" data-original-title="Check out more demos" v-if="$parent.permissions.includes('product-unit-list')">
                                                ...
                                                <table id="productUnitTable" class="display dataTable no-footer order--table" role="grid">
                                                    ...
                                                    <tbody class="kt-table-tbody text-dark">
                                                        <tr class="kt-table-row kt-table-row-level-0 odd" role="row" v-for="unit in units" v-bind:key="unit.unit_id">
                                                            ...
                                                            <td>
                                                                <span :class="unit.is_active == '1' ? 'active-status' : 'deactive-status'">
                                                                    <span class="badge" :class="unit.is_active == '1' ? 'badge-light-success' : 'badge-light-danger'" >
                                                                        {{ unit.is_active == '1' ? 'Active' : 'InActive' }}
                                                                      </span>
                                                                </span>
                                                            </td>
                                                            <td v-if="$parent.permissions.includes('product-unit-manage')" class="white__nowrap">
                                                                <a href="javascript:void(0)" class="click-edit btn btn-outline-primary text-nowrap waves-effect p-2 mr-3" id="click-edit1" data-toggle="tooltip" title="" data-placement="right" data-original-title="Check out more demos" @click="editunit(unit)"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg><span class="pl-2">Edit</span></a>
                                                                <a class="btn btn-outline-danger text-nowrap  waves-effect p-2" href="#" @click="deleteunit(unit.id)">
    ...
    <div class="offcanvas_backdrop" v-if="display_form">
        <div class="offcanvas offcanvas-right kt-color-panel p-5 kt_notes_panel"  :class="display_form ? 'offcanvas-on' : ''">
            ...
            <form id="myform">
                ...
                <button type="button" @click="addUpdateunit()" class="btn btn-primary w-100 mt-3">Submit</button>
            </form>
        </div>
    </div>
</div>
