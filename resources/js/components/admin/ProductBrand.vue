                            ...
                            <div class="card card-custom gutter-b bg-transparent shadow-none border-0">
                                <div class="card-header align-items-center  border-bottom-dark px-0">
                                    ...
                                    <div class="icons d-flex">
                                        <button class="btn ml-2 p-0 kt_notes_panel_toggle btn-outline-black" data-toggle="tooltip" title="" data-placement="right" data-original-title="Check out more demos" v-if="$parent.permissions.includes('product-brand-manage')">
                                            <span class="h-30px font-size-h5 bg-white w-30px d-flex align-items-center justify-content-center shadow-sm  " v-on:click="
                                                    ...
                                                    ">
                                                <svg width="25px" height="25px" viewBox="0 0 16 16" class="bi bi-plusSelect Image file from gallary." fill="currentColor" xmlns="http://www.w3.org/2000/svg">
                                    ...
                                    <div>
                                        <div class=" table-responsive" id="printableTable">
                                            ...
                                            <div id="productbrandTable_wrapper" class="dataTables_wrapper no-footer">
                                                ...
                                                <div class="dataTables_length mb-3" id="productbrandTable_length"><label>Show
                                                ...
                                                <div id="productbrandTable_filter" class="dataTables_filter mb-3">
                                                ...
                                                <table id="productbrandTable" class="display dataTable no-footer order--table" role="grid">
                                                    ...
                                                    <tbody class="kt-table-tbody text-dark">
                                                        <tr class="kt-table-row kt-table-row-level-0 odd" role="row" v-for="brand in brands" v-bind:key="brand.brand_id">
                                                            ...
                                                            <td>
                                                                <!-- <span :class="brand.brand_status == '1' ? 'active-status' : 'deactive-status'">
                                                                    <span class="badge" :class="brand.brand_status == '1' ? 'badge-light-primary' : 'badge-light-danger'" >
                                                                        {{ brand.brand_status == '1' ? 'Active' : 'InActive' }}
                                                                    </span>
                                                                </span> -->
                                                                 <span :class="brand.brand_status == 'active' ? 'active-status' : 'deactive-status'">
                                                                    <span class="badge" :class="brand.brand_status == 'active' ? 'badge-light-success' : 'badge-light-danger'" >
                                                                       {{ brand.brand_status }} 
                                                                    </span>
                                                                </span>
                                                                
                                                            </td>
                                                            <td v-if="$parent.permissions.includes('product-brand-manage')" class="white__nowrap">
                                                                <a href="javascript:void(0)" class=" click-edit btn btn-outline-primary text-nowrap waves-effect p-2  mr-3" id="click-edit1" data-toggle="tooltip" title="" data-placement="right" data-original-title="Check out more demos" @click="editbrand(brand)"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-edit"><path d="M11 4H4a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h14a2 2 0 0 0 2-2v-7"></path><path d="M18.5 2.5a2.121 2.121 0 0 1 3 3L12 15l-4 1 1-4 9.5-9.5z"></path></svg><span class="pl-2">Edit</span></a>
                                                                <a class="btn btn-outline-danger text-nowrap  waves-effect p-2" href="#" @click="deletebrand(brand.brand_id)"><svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-x me-25"><line x1="18" y1="6" x2="6" y2="18"></line><line x1="6" y1="6" x2="18" y2="18"></line></svg><span>Delete</span>
                                                                </a>
                                                            </td>
                                                        </tr>
                                                        <tr v-if="brands.length == 0" class="text-center font-size-16"><td colspan="5">No Order Found</td></tr>
                                                    </tbody>
                                                </table>
                                                <ul class="pagination pagination-sm mb-0 mt-3 justify-content-end align-items-center px-2" v-if="brands.length != 0">
                                                    <li v-bind:class="[{disabled: !pagination.prev_page_url}]"><button class="page-link" href="#" @click="fetchbrands(pagination.prev_page_url)">
                                                    ...
                                                    <li v-bind:class="[{disabled: !pagination.next_page_url}]" class="page-item"><button class="page-link" href="#" @click="fetchbrands(pagination.next_page_url)">
            ...
            <form id="myform">
                <div class="row">
                    <div class="col-12">
                        ...
                        <div class="form-group">
                            <button type="button" class="btn btn-outline-primary border_radius_5" @click="toggleImageSelect()">Upload Brand Media</button>
    ...
    methods: {
        ...
        fetchbrands(page_url) {
            ...
            if(Number.isInteger(page_url)){
                page_url ="/api/admin/brand?page="+page_url;
            }
